...
# This file intentionally contains copy-paste shell examples and reusable patterns
# for this repository. It is not meant to be sourced as a library in scripts.
# Instead, copy the functions you need into a new script.
#
# Purpose: keep common shell helpers in one place without pretending they are a
# normal importable library.
#
